...
void GasCountDown::VUpdate_40C0E0()
{
    ...
    // Enable
    if (!sGasTimer_507700 && sSwitchStates_505568.Get(field_60_switch_id) && !sSwitchStates_505568.Get(NamedSwitchIDs::AO_GameBeaten))
    {
        sGasTimer_507700 = gnFrameCount_507670;
        auto pAlarm = ao_new<Alarm>();
        if (pAlarm)
        {
            pAlarm->ctor_402570(3600, NamedSwitchIDs::None, 0, Layer::eLayer_Above_FG1_39);
        }
    }
