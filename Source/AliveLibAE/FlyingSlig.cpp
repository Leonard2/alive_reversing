...
FlyingSlig* FlyingSlig::ctor_4342B0(Path_FlyingSlig* pTlv, s32 tlvInfo)
{
    ...
    field_17C_launch_id |= field_118_data.field_10_data.field_1C_launch_id.mId;
...
s32 CC FlyingSlig::CreateFromSaveState_437E40(const u8* pBuffer)
{
    ...
    pFlyingSlig->field_17C_launch_id = pSaveState->field_38_launch_id.mId;
...
s32 FlyingSlig::vGetSaveState_43B1E0(FlyingSlig_State* pState)
{
    ...
    pState->field_38_launch_id.mId = field_17C_launch_id;
...
void FlyingSlig::Movement_4396E0()
{
    ...
    {
        if (static_cast<s32>(sGnFrame_5C1B84) > field_150_grenade_delay && (field_114_flags.Get(Flags_114::e114_Bit4_bPossesed) || sSwitchStates_5C1A28.Get({ field_17C_launch_id }) || field_114_flags.Get(Flags_114::e114_Bit4_bPossesed)) && CanThrowGrenade_43A490())
        {
            ThrowGrenade_43A1E0();
        }
    }
