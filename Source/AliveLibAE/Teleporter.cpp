...
Teleporter* Teleporter::ctor_4DC1E0(Path_Teleporter* pTlv, u32 tlvInfo)
{
    ...
    field_2C_switch_state = sSwitchStates_5C1A28.Get(field_34_mTlvData.field_1A_trigger_id);
...
void Teleporter::vUpdate_4DC400()
{
    ...
    switch (field_30_state)
    {
        case TeleporterState::eWaitForSwitchOn_0:
        {
            ...
            if (sSwitchStates_5C1A28.Get(field_34_mTlvData.field_1A_trigger_id) == field_2C_switch_state)
            {
                return;
            }
